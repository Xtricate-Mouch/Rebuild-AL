...
//                         if AllObjWithCaptionPage.RunModal() <> Action::LookupOK then exit;
...
//         if SourceTableNo <> 0 then RunDataEditorList();
//     end;
...
//         RecRef: RecordRef;
//     begin
//         if SourceTableNo = 0 then exit;
//         RecRef.Open(SourceTableNo);
//         if TableView <> '' then RecRef.SetView(TableView);
...
//         if CustomTableView <> '' then CustomFilterPageBuilder.SetView(SourceTableName, CustomTableView);
