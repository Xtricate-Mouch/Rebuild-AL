// page 50314 "DET Insert New Record"
// {
...
//     begin
//         if not(CloseAction in[CloseAction::OK, CloseAction::LookupOK])then exit;
//         if FieldVisible1 then begin
//             FieldRefToInsert:=GetFieldRefByCounter(1);
//             FieldRefToInsert.Value(VariantValue1);
//             if not WithoutValidation then FieldRefToInsert.Validate();
//         end;
...
//         FieldInfoDictionaty: Dictionary of[Integer, Text];
//     begin
//         if GlobalRecRef.Number() = 0 then exit;
//         FieldInfoDictionaty:=GenFieldInfoDict.Get(FieldCounter);
//         foreach OriginalFieldNo in FieldInfoDictionaty.Keys()do FieldRefVar:=GlobalRecRef.Field(OriginalFieldNo);
...
//             if NameValueLookup.RunModal() <> Action::LookupOK then exit;
...
//             if not(EditValue.RunModal()in[Action::OK, Action::LookupOK])then exit;
//             EditValue.GetResult(ResultVariant);
//         end;
//         case FieldCounter of 1: VariantValue1:=ResultVariant;
//         2: VariantValue2:=ResultVariant;
//         3: VariantValue3:=ResultVariant;
//         4: VariantValue4:=ResultVariant;
//         5: VariantValue5:=ResultVariant;
//         6: VariantValue6:=ResultVariant;
//         7: VariantValue7:=ResultVariant;
//         8: VariantValue8:=ResultVariant;
//         9: VariantValue9:=ResultVariant;
//         10: VariantValue10:=ResultVariant;
//         11: VariantValue11:=ResultVariant;
//         12: VariantValue12:=ResultVariant;
//         13: VariantValue13:=ResultVariant;
//         14: VariantValue14:=ResultVariant;
//         15: VariantValue15:=ResultVariant;
//         end;
//         if FieldRefVar.Type() = FieldRefVar.Type::Option then NewValue:=TempNameValueBuffer.Value
//         else
...
//         FieldInfoDictionaty:=GenFieldInfoDict.Get(FieldCounter);
//         foreach OriginalFieldNo in FieldInfoDictionaty.Keys()do FieldRefVar:=GlobalRecRef.Field(OriginalFieldNo);
//         case FieldCounter of 1: VariantValue1:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         2: VariantValue2:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         3: VariantValue3:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         4: VariantValue4:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         5: VariantValue5:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         6: VariantValue6:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         7: VariantValue7:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         8: VariantValue8:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         9: VariantValue9:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         10: VariantValue10:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         11: VariantValue11:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         12: VariantValue12:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         13: VariantValue13:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         14: VariantValue14:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         15: VariantValue15:=DataEditorBufferPage.TextValueAsVariant(FieldRefVar.Type(), NewValue);
//         end;
//     end;
//     local procedure GetFieldRefByCounter(FieldCounter: Integer): FieldRef var
//         OriginalFieldNo: Integer;
//         FieldInfoDictionaty: Dictionary of[Integer, Text];
//     begin
//         FieldInfoDictionaty:=GenFieldInfoDict.Get(FieldCounter);
//         foreach OriginalFieldNo in FieldInfoDictionaty.Keys()do exit(GlobalRecRef.Field(OriginalFieldNo));
//     end;
//     procedure GetResultRecordID(): RecordId begin
//         exit(GlobalRecRef.RecordId());
//     end;
//     var GlobalRecRef: RecordRef;
//     [InDataSet]
