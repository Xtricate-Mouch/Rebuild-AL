// page 50316 "DET Run Editor From Filter"
// {
...
//     begin
//         if Rec.GetFilter("Table Number") = '' then exit;
//         Evaluate(SourceTableNo, Rec.GetFilter("Table Number"));
//         if Rec.GetFilter("Without Validate") <> '' then Evaluate(WithoutValidate, Rec.GetFilter("Without Validate"));
//         if Rec.GetFilter("Exclude FlowFields") <> '' then Evaluate(ExcludeFlowFields, Rec.GetFilter("Exclude FlowFields"));
