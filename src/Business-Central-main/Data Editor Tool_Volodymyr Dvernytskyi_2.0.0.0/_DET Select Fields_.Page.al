...
//         if CurrentIdFilter <> '' then FieldRec2.SetFilter("No.", CurrentIdFilter);
...
//         if ShowOnlyFilteredFields then FieldRec.SetFilter("No.", CurrentIdFilter);
