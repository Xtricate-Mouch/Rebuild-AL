...
//     begin
//         if FieldInfo.RelationTableNo = 0 then exit;
//         RecRef.Open(FieldInfo.RelationTableNo);
//         VariantRecord:=RecRef;
//         if not(Page.RunModal(0, VariantRecord)in[Action::LookupOK, Action::OK])then exit;
...
//     begin
//         case true of IsBooleanValue: result:=BooleanValue;
//         isCodeValue: result:=CodeValue;
//         IsTextValue: result:=TextValue;
//         IsIntegerValue: result:=IntegerValue;
//         IsDecimalValue: result:=DecimalValue;
//         IsDateValue: result:=DateValue;
//         IsDateFormulaValue: result:=DateFormulaValue;
//         IsDateTimeValue: result:=DateTimeValue;
//         IsTimeValue: result:=TimeValue;
//         IsGuidValue: result:=GuidValue;
//         end;
//     end;
