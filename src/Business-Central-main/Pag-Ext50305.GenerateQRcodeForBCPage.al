...
pageextension 50305 CustomerListExt extends "Customer Card"
{
    actions
    {
...
report 50305 CustomerCardBarCode
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    Caption = 'Customer Card Barcodes';
    RDLCLayout = './src/Business-Central-main/Layout/CustCardBarcodes.rdl';
    dataset
    {
