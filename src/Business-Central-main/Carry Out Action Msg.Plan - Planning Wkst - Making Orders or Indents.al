report 50311 "Carry Out Action Msg.Plan.MTAR"
{
    ...
    dataset
    {
        dataitem("Requisition Line"; "Requisition Line")
        {
            ...
            begin
                ...
                //  CarryOutAction.PrintAsmOrders(); //Check

                //if PurchOrderChoice in [PurchOrderChoice::"Make Purch. Orders",
                // PurchOrderChoice::"Make Purch. Orders & Print", PurchOrderChoice::"Make Purchase Indent"]
                if (PurchOrderChoice = PurchOrderChoice::"Make Purch. Orders") or (PurchOrderChoice = PurchOrderChoice::"Make Purch. Orders & Print") //B2BKM26AUG2024
                   ...
                   then begin
                    ...
                    if PurchaseSuggestionExists("Requisition Line") then begin
                        ...
                        Printindent := (PurchOrderChoice = PurchOrderChoice::"Make Purchase Indent");
                        Clear(ReqWkshMakeOrders);
                        ReqWkshMakeOrders.SetCreatedDocumentBuffer(TempDocumentEntry);
                        ReqWkshMakeOrders.Set(PurchOrderHeader, EndOrderDate, PrintOrders, Printindent);
                ...
                //B2BKM26AUG2024 <<
                IF (PurchOrderChoice = PurchOrderChoice::"Make Purchase Indent") then begin
                    SetRange("Accept Action Message", true);
