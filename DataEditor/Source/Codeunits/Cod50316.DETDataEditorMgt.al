...
codeunit 50316 "DET Data Editor Mgt."
{
    ...
    procedure ExportTable(var DataEditorBuffer: Record "New DET Data Editor Buffer"; FieldIdsToExport: List of [Integer])
    var
        ImportExportDialog: Page "DET Import/Export Dialog";
        FileFormat: Enum "DET File Format";
    ...
    local procedure ExportExcel(var DataEditorBuffer: Record "New DET Data Editor Buffer"; FieldIdsToExport: List of [Integer]; ExportBLOB: Boolean; ExportMedia: Boolean)
    var
        TempExcelBuffer: Record "Excel Buffer" temporary;
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    local procedure ExportJSON(var DataEditorBuffer: Record "New DET Data Editor Buffer"; FieldIdsToExport: List of [Integer]; ExportBLOB: Boolean; ExportMedia: Boolean)
    var
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    procedure ReadRecord(var TempDataEditorBuffer: Record "New DET Data Editor Buffer" temporary; JObject: JsonObject; NumberOfThreads: Integer; TotalRecordCount: Integer) ActiveSessionId: Integer
    var
    ...
    procedure MergeBufferData(var TempDataEditorBufferResult: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer1: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer2: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer3: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer4: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer5: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer6: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer7: Record "New DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer8: Record "New DET Data Editor Buffer" temporary)
    var
        PrevFilters: Text;
    begin
